/*
  ...
  Output Channel and how to periodically read from the programmable
  Digital IO Input Channel.
...
void readAll() {
  // Reads from input pin, this API return  -1 if try to read from write channel
